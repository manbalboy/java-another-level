...
public class BasicAuthenticationTest {
    ...
    void test_2() {
        ...
        header.add(HttpHeaders.AUTHORIZATION, "Basic " + Base64.getEncoder()
                .encodeToString("user1:1111".getBytes()));
...
//        System.out.println(resp);
    ...
    @DisplayName("3. 인증성공 2")
    @Test
    void test_3() {
        TestRestTemplate testRestTemplate = new TestRestTemplate("user1", "1111");
        String resp = testRestTemplate.getForObject(greetingUrl(), String.class);
    ...
    void test_4() {
        TestRestTemplate testRestTemplate = new TestRestTemplate("user1", "1111");
        ResponseEntity<String> resp = testRestTemplate.postForEntity(greetingUrl(), "hun", String.class);

        assertEquals("hello hun", resp.getBody());
    }
